...
if _name_ == '_main_':
    ...
    ep_chassis.move(x=1.26, y=0, z=0, xy_speed=1).wait_for_completed()
    ...
    ep_chassis.move(x=1.20, y=0, z=0, xy_speed=1).wait_for_completed()
    ep_led.set_led(comp = "all",r=255,g=100,b=0,effect="on")
    ...
    ep_chassis.move(x=0.65, y=0, z=0, xy_speed=1).wait_for_completed()
    ep_led.set_led(comp = "all",r=255,g=100,b=0,effect="on")
    ...
    ep_chassis.move(x=0.26, y=0, z=0, xy_speed=1).wait_for_completed()
    ep_led.set_led(comp = "all",r=255,g=100,b=0,effect="on")
...
![WhatsApp Image 2025-11-14 at 18 07 28_49f10a3e](https://github.com/user-attachments/assets/321c358f-545a-414d-83a7-90dfc74b5065)

![WhatsApp Image 2025-11-14 at 18 07 28_10e98053](https://github.com/user-attachments/assets/95715a91-b3d2-4be1-a465-5601ed59b0e4)
...
https://youtube.com/shorts/sD4zr5rKyuQ?si=9xpkzAOvkrtshAtl
...
```<img width="523" height="492" alt="image" src="https://github.com/user-attachments/assets/4960225e-6b4b-40ec-af31-76f4902c412d" />
